...
Revision ID: 6bd495384e90
Revises: 9e7b543d08a3
Create Date: 2025-06-10 08:54:31.743851
...
def downgrade():
    ...
    sa.Column('booking_id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('amount', sa.NUMERIC(precision=10, scale=2), autoincrement=False, nullable=False),
    sa.Column('payment_method', postgresql.ENUM('cash', 'bank_transfer', 'credit_card', 'momo', 'zalopay', 'vnpay', name='payment_method'), autoincrement=False, nullable=False),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['category_id'], ['service_categories.id'], name='services_category_id_fkey', ondelete='SET NULL'),
    ...
    sa.Column('id', sa.UUID(), server_default=sa.text('gen_random_uuid()'), autoincrement=False, nullable=False),
    sa.Column('user_id', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('method_type', postgresql.ENUM('cash', 'bank_transfer', 'credit_card', 'momo', 'zalopay', 'vnpay', name='payment_method'), autoincrement=False, nullable=False),
    ...
    sa.Column('payment_method', postgresql.ENUM('cash', 'bank_transfer', 'credit_card', 'momo', 'zalopay', 'vnpay', name='payment_method'), autoincrement=False, nullable=True),
    sa.Column('notes', sa.TEXT(), autoincrement=False, nullable=True),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['address_id'], ['user_addresses.id'], name=op.f('bookings_address_id_fkey'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['cancelled_by'], ['users.id'], name=op.f('bookings_cancelled_by_fkey'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['staff_id'], ['users.id'], name=op.f('bookings_staff_id_fkey'), ondelete='SET NULL'),
    ...
    sa.UniqueConstraint('booking_code', name=op.f('bookings_booking_code_key'))
    )
    with op.batch_alter_table('bookings', schema=None) as batch_op:
